...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newCar, savedCar, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                newCar = new car_1.default(req.body);
...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, car_1.default.find({})];
            case 1:
                Cars = _a.sent();
...
router.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, car_1.default.findById(req.params.id)];
            case 1:
                Cars = _a.sent();
                if (!Cars) {
...
// Get By ID 
router.get('/owner/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var Cars, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, car_1.default.find({ 'ownerId': req.params.id })];
            case 1:
                Cars = _a.sent();
                if (!Cars) {
                    res.status(400).json({ error: 'Cannot find this Car' });
...
router.delete('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var CarId, isReferenced, deletedCar, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                CarId = req.params.id;
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, carTracking_1.default.exists({ carId: CarId })];
            case 2:
                ...
                return [4 /*yield*/, car_1.default.findByIdAndDelete(CarId)];
            case 3:
                deletedCar = _a.sent();
                if (!deletedCar) {
            ...
            case 4:
                err_5 = _a.sent();
                console.error('Error deleting Car:', err_5);
                next(err_5);
                return [3 /*break*/, 5];
